...
//TODO: change the currency and country prefix as per your need
  ...
  String urlPrefix = 'https://cookhaven.page.link';

//TODO:change this package name to yours
  String packageName = 'com.cookhaven.grocery_store_admin';
  ...
  String updateMessagesUrl =
      'https://us-central1-cookhaven.cloudfunctions.net/updateAnsweredMessageAnalytics'; //it should look something like : https://us-********-**********.cloudfunctions.net/updateAnsweredMessageAnalytics
